 ...
 */
public class XingxingScrollView extends FrameLayout {
    ...
    public XingxingScrollView(Context context) {
        this(context, null);
    }

    public XingxingScrollView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initScrollView();
    }
